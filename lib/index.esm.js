...
var CalendarColumn = function (_a) {
    var className = _a.className, date = _a.date, handleColumnClick = _a.handleColumnClick, label = _a.label;
    return (jsx("button", __assign({ className: classNames("ra-calendar-column", className), onClick: function () { return handleColumnClick(date); } }, { children: jsx("span", __assign({ className: "ra-calendar-column__label" }, { children: label })) }), date.format("YYYY-MM-DDTHH:mm:ssZ")));
};

var CalendarBody = function (_a) {
    _a.appointments; var dateRange = _a.dateRange, handleColumnClick = _a.handleColumnClick;
    return (jsx("div", __assign({ className: "ra-calendar-body" }, { children: dateRange.items.map(function (column) { return (jsx(CalendarColumn, __assign({}, column, { handleColumnClick: handleColumnClick }), column.key)); }) })));
};
...
var Modal = function (_a) {
    var className = _a.className, currentDate = _a.currentDate, setIsModalOpen = _a.setIsModalOpen;
    ...
    return (jsx("div", __assign({ ref: modalRef, className: classNames("modal", className), onClick: handleModalClick }, { children: jsx("div", __assign({ className: "modal__box" }, { children: currentDate.format("DD MMMM YYYY") })) })));
};
...
var ReactAppoint = function (_a) {
    ...
    var _g = useState(dayjs()), modalDate = _g[0], setModalDate = _g[1];
    useEffect(function () {
