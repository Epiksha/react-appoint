...
var Header = function (_a) {
    ...
    return (jsxs("header", __assign({ className: "ra-header" }, { children: [jsx("div", __assign({ className: "ra-header__range" }, { children: jsx("p", { children: "< 11 - 17 FEBRUARY 2023 >" }) })), jsx("div", __assign({ className: "ra-header__options" }, { children: optionLabels.map(function (label) { return (jsx("button", __assign({ className: classNames("ra-header__option", { "ra-header__option--active": label.toLowerCase() === rangeType }), onClick: function () { return handleRangeChange(label.toLowerCase()); } }, { children: label }), label)); }) }))] })));
};
...
var ReactAppoint = function (_a) {
    ...
    return (jsxs("div", __assign({ className: "ra-container" }, { children: [jsx(Header, { rangeType: rangeType, handleRangeChange: setRangeType }), jsx(Calendar, { appointments: appointments, rangeType: rangeType, dateRange: dateRange, times: times })] })));
};
