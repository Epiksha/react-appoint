...
var CalendarBody = function (_a) {
    ...
    return (jsx("div", __assign({ className: "ra-calendar-body" }, { children: dateRange.items.map(function (column) { return (jsx(CalendarColumn, __assign({}, column), column.key)); }) })));
};
...
var Calendar = function (_a) {
    ...
    return (jsxs("div", __assign({ className: classNames("ra-calendar", "ra-calendar--".concat(rangeType)) }, { children: [jsx(CalendarHeader, { dateRange: dateRange, rangeType: rangeType }), jsx(CalendarBody, { appointments: appointments, dateRange: dateRange, rangeType: rangeType, times: times })] })));
};
...
var ReactAppoint = function (_a) {
    ...
    return (jsxs("div", __assign({ className: "ra-container" }, { children: [jsx(Header, { dateRange: dateRange, rangeType: rangeType, handleDateRangeChange: handleDateRangeChange, handleRangeTypeChange: setRangeType }), jsx(Calendar, { appointments: appointments, rangeType: rangeType, dateRange: dateRange, times: times })] })));
};
