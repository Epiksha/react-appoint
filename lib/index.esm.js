...
var Header = function (_a) {
    var dateRange = _a.dateRange, handleRangeChange = _a.handleRangeChange, rangeType = _a.rangeType;
    ...
    return (jsxs("header", __assign({ className: "ra-header" }, { children: [jsxs("div", __assign({ className: "ra-header__range" }, { children: [jsx("button", __assign({ className: "ra-header__range-trigger ra-header__range-trigger--previous" }, { children: "<" })), jsx("p", { children: currentLabel }), jsx("button", __assign({ className: "ra-header__range-trigger ra-header__range-trigger--next" }, { children: ">" }))] })), jsx("div", __assign({ className: "ra-header__options" }, { children: optionLabels.map(function (label) { return (jsx("button", __assign({ className: classNames("ra-header__option", { "ra-header__option--active": label.toLowerCase() === rangeType }), onClick: function () { return handleRangeChange(label.toLowerCase()); } }, { children: label }), label)); }) }))] })));
};
...
var ReactAppoint = function (_a) {
    ...
    return (jsxs("div", __assign({ className: "ra-container" }, { children: [jsx(Header, { dateRange: dateRange, rangeType: rangeType, handleRangeChange: setRangeType }), jsx(Calendar, { appointments: appointments, rangeType: rangeType, dateRange: dateRange, times: times })] })));
};
