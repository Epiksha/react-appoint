...
var Appointment = function (_a) {
    ...
    return (jsx("button", __assign({ className: "ra-appointment", style: { width: "".concat(100 * days, "%") }, onClick: handleAppointmentClick }, { children: jsx("p", __assign({ className: "ra-appointment__title" }, { children: title })) })));
};
...
var CalendarColumn = function (_a) {
    ...
    var dayAppointments = useMemo(function () { return (appointments.filter(function (appointment) { return (dayjs(appointment.startDate).startOf("day").format("YY-MM-DDTHH:MM") === dayjs(date).startOf("day").format("YY-MM-DDTHH:MM")); })); }, [appointments, date]);
    return (jsxs("div", __assign({ className: "ra-calendar-column" }, { children: [jsx("button", __assign({ className: classNames("ra-calendar-column__trigger", className), onClick: handleDateClick }, { children: jsx("span", __assign({ className: "ra-calendar-column__trigger-label" }, { children: label })) })), dayAppointments.map(function (appointment) { return (jsx(Appointment, __assign({}, appointment), appointment.title)); })] }), date.format("YYYY-MM-DDTHH:mm:ssZ")));
};
...
var CalendarBody = function (_a) {
    ...
    return (jsx("div", __assign({ className: "ra-calendar-body" }, { children: dateRange.items.map(function (column) { return (jsx(CalendarColumn, __assign({ appointments: appointments }, column, { handleColumnClick: handleColumnClick }), column.key)); }) })));
};
