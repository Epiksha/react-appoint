...
var Header = function (_a) {
    ...
    return (jsxs("header", __assign({ className: "ra-header" }, { children: [jsxs("div", __assign({ className: "ra-header__range" }, { children: [jsx("button", __assign({ className: "ra-header__range-trigger ra-header__range-trigger--previous", onClick: function () { return handleDateRangeChange("previous"); } }, { children: "<" })), jsx("p", { children: currentLabel }), jsx("button", __assign({ className: "ra-header__range-trigger ra-header__range-trigger--next", onClick: function () { return handleDateRangeChange("next"); } }, { children: ">" }))] })), jsx("div", __assign({ className: "ra-header__options" }, { children: optionLabels.map(function (label) { return (jsx("button", __assign({ className: classNames("ra-header__option", { "ra-header__option--active": label.toLowerCase() === rangeType }), onClick: function () { return handleRangeTypeChange(label.toLowerCase()); } }, { children: label }), label)); }) }))] })));
};
