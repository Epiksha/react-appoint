...
var CalendarColumn = function (_a) {
    ...
    return (jsxRuntime.jsx("button", __assign({ className: classNames("ra-calendar-column", className), onClick: handleDateClick }, { children: jsxRuntime.jsx("span", __assign({ className: "ra-calendar-column__label" }, { children: label })) }), date.format("YYYY-MM-DDTHH:mm:ssZ")));
};
