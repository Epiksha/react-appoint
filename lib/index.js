...
var CalendarColumn = function (_a) {
    ...
    return (jsxRuntime.jsx("button", __assign({ className: classNames("ra-calendar-column", className), onClick: function () { return handleColumnClick(date); } }, { children: jsxRuntime.jsx("span", __assign({ className: "ra-calendar-column__label" }, { children: label })) }), date.format("YYYY-MM-DDTHH:mm:ssZ")));
};

var CalendarBody = function (_a) {
    _a.appointments; var dateRange = _a.dateRange, handleColumnClick = _a.handleColumnClick;
    return (jsxRuntime.jsx("div", __assign({ className: "ra-calendar-body" }, { children: dateRange.items.map(function (column) { return (jsxRuntime.jsx(CalendarColumn, __assign({}, column, { handleColumnClick: handleColumnClick }), column.key)); }) })));
};
...
var Header = function (_a) {
    ...
    return (jsxRuntime.jsxs("header", __assign({ className: "ra-header" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "ra-header__range" }, { children: [jsxRuntime.jsx("button", __assign({ className: "ra-header__range-trigger ra-header__range-trigger--previous", onClick: function () { return handleDateRangeChange("previous"); } }, { children: "<" })), jsxRuntime.jsx("p", { children: currentLabel }), jsxRuntime.jsx("button", __assign({ className: "ra-header__range-trigger ra-header__range-trigger--next", onClick: function () { return handleDateRangeChange("next"); } }, { children: ">" }))] })), jsxRuntime.jsx("div", __assign({ className: "ra-header__options" }, { children: optionLabels.map(function (label) { return (jsxRuntime.jsx("button", __assign({ className: classNames("ra-header__option", { "ra-header__option--active": label.toLowerCase() === rangeType }), onClick: function () { return handleRangeTypeChange(label.toLowerCase()); } }, { children: label }), label)); }) }))] })));
};
...
var Modal = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ ref: modalRef, className: classNames("modal", className), onClick: handleModalClick }, { children: jsxRuntime.jsx("div", __assign({ className: "modal__box" }, { children: currentDate.format("DD MMMM YYYY") })) })));
};
...
var ReactAppoint = function (_a) {
    ...
    var _g = react.useState(dayjs()), modalDate = _g[0], setModalDate = _g[1];
    react.useEffect(function () {
