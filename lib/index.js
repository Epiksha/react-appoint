...
var Appointment = function (props) {
    ...
    return (jsxRuntime.jsx("button", __assign({ className: "ra-appointment", onClick: handleAppointmentClick }, { children: jsxRuntime.jsx("p", __assign({ className: "ra-appointment__title" }, { children: title })) })));
};
...
var CalendarColumn = function (_a) {
    ...
    var dayAppointments = react.useMemo(function () {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames("ra-calendar-column", { "ra-calendar-column--time": isTimeColumn }, className) }, { children: [isTimeColumn ? (jsxRuntime.jsx("div", __assign({ className: "ra-calendar-column__trigger" }, { children: label ? (jsxRuntime.jsx("span", __assign({ className: "ra-calendar-column__trigger-label" }, { children: label }))) : null }))) : (jsxRuntime.jsx("button", __assign({ className: "ra-calendar-column__trigger", onClick: handleDateClick }, { children: label ? (jsxRuntime.jsx("span", __assign({ className: "ra-calendar-column__trigger-label" }, { children: label }))) : null }))), dayAppointments.length ? (jsxRuntime.jsx("div", __assign({ className: "ra-appointments" }, { children: dayAppointments.map(function (appointment) { return (jsxRuntime.jsx(Appointment, __assign({}, appointment, { rangeType: rangeType }), appointment.title)); }) }))) : null] }), date.format("YYYY-MM-DDTHH:mm:ssZ")));
};
...
var CalendarBody = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: "ra-calendar-body" }, { children: dateRange.items.map(function (column) { return (jsxRuntime.jsx(CalendarColumn, __assign({ appointments: appointments }, column, { handleColumnClick: handleColumnClick, rangeType: rangeType }), column.key)); }) })));
};
