...
var CalendarColumn = function (_a) {
    ...
    return (jsxRuntime.jsx("button", __assign({ className: classNames("ra-calendar-column", className), onClick: function () { return handleColumnClick(date); } }, { children: label }), date.format("YYYY-MM-DDTHH:mm:ssZ")));
};
