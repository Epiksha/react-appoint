...
var Header = function (_a) {
    ...
    return (jsxRuntime.jsxs("header", __assign({ className: "ra-header" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "ra-header__range" }, { children: [jsxRuntime.jsx("button", __assign({ className: "ra-header__range-trigger ra-header__range-trigger--previous" }, { children: "<" })), jsxRuntime.jsx("p", { children: currentLabel }), jsxRuntime.jsx("button", __assign({ className: "ra-header__range-trigger ra-header__range-trigger--next" }, { children: ">" }))] })), jsxRuntime.jsx("div", __assign({ className: "ra-header__options" }, { children: optionLabels.map(function (label) { return (jsxRuntime.jsx("button", __assign({ className: classNames("ra-header__option", { "ra-header__option--active": label.toLowerCase() === rangeType }), onClick: function () { return handleRangeChange(label.toLowerCase()); } }, { children: label }), label)); }) }))] })));
};
...
var ReactAppoint = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "ra-container" }, { children: [jsxRuntime.jsx(Header, { dateRange: dateRange, rangeType: rangeType, handleRangeChange: setRangeType }), jsxRuntime.jsx(Calendar, { appointments: appointments, rangeType: rangeType, dateRange: dateRange, times: times })] })));
};
